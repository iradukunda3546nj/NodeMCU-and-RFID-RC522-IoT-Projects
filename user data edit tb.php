		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						<label class="control-label">Laptop's Serial</label>
						<div class="controls">
							<input name="serial" type="text"  placeholder="" value="<?php echo $data['serial'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="year" type="text"  placeholder="" value="<?php echo $data['year'];?>" required>
						</div>
					</div>
